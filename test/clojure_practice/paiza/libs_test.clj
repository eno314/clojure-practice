...
(deftest test-read-lines
  (testing "read-lines with line-length 3"
    (with-in-str "1\n2\n3\n4\n5\n"
      (is (= (read-lines 3) ["1" "2" "3"]))))
  (testing "read-lines with line-length 5"
    (with-in-str "a\nbb\nccc\ndddd\neeeee\n"
...
(deftest test-read-lines-split-by-space
  (with-in-str "1 2 3 4 5\n"
    (is (= (read-lines-split-by-space 1) [["1" "2" "3" "4" "5"]])))
  (with-in-str "1 2\na bb ccc ddd\n"
    (is (= (read-lines-split-by-space 2) [["1" "2"] ["a" "bb" "ccc" "ddd"]]))))
...
(deftest read-int-values-lines-test
  (with-in-str "1 2\n3\n4 5\n"
